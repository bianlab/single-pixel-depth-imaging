...
autoencoder.train()
autoencoder=torch.load("/home/why/mnn/netfuhe.pt") # netk--train halfball+dixing,netfuhe--train all objects with MSELoss
...
dataloader1 = DataLoader(ImageFolder('/home/why/mnn/halfball+dixing_data/test_1e-2/', img_size=64),
                        batch_size=1, shuffle=False)

dataloader2 = DataLoader(ImageFolder('/home/why/mnn/halfball+dixing_data/test_1e-2/', img_size=64),
                        batch_size=1, shuffle=False)
...
for epoch in range(EPOCH):
    for a,b in zip(enumerate(dataloader1),enumerate(dataloader2)):
        ...
        in_img=a[1][1]
        f=open("/home/why/mnn/halfball+dixing_data/3d_txt_ball+dixing/"+str(a[0]+1)+".txt","r")
        e=np.eye(64)
        ...
        if a[0] % 1 == 0:
             ...
             #scipy.misc.imsave("/home/why/mnn/net_1120/h/"+str(a[0])+".jpg",decoded.data.numpy()[0][0])
